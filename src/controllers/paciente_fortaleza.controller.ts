...
class Paciente_FortalezaController {
  ...
  public async getPaciente_FortalezaById(req: Request, res: Response) {
    try {
      const { id } = req.params;
      const Paciente_fortaleza = await Paciente_FortalezaService.getPaciente_FortalezaById(String(id));
  ...
  public async getPaciente_FortalezaByPacienteId(req: Request, res: Response) {
    try {
      ...
      const Paciente_fortaleza = await Paciente_FortalezaService.getPaciente_FortalezaByPacienteId(String(pacienteId));
      res.status(200).json(Paciente_fortaleza);
    } catch (error) {
      res.status(404).json((error as Error).message);
    }
  ...
  public async updatePaciente_Fortaleza(req: Request, res: Response) {
    try {
      const { id } = req.params;
      const data = req.body;
      const updatedPaciente_fortaleza = await Paciente_FortalezaService.updatePaciente_Fortaleza(String(id), data);
  ...
  public async deletePaciente_Fortaleza(req: Request, res: Response) {
    try {
      const { id } = req.params;
      await Paciente_FortalezaService.deletePaciente_Fortaleza(String(id));
